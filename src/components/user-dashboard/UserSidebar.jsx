...
export default function Sidebar({ isOpen }) {
  ...
  return (
    <aside className={`fixed top-16 left-0 h-[calc(100%-4rem)] bg-[#08075c] p-4 space-y-2 overflow-y-auto flex-shrink-0 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 w-44 z-20`}>
      {menuItems.map((item) => (
